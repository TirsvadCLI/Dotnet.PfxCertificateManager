param(
    ...
    [string]$ProjectFilePath = "$PSScriptRoot/src/PfxCertificateManager/TirsvadCLI.PfxCertificateManager.csproj",
...
Write-Output "NuGet package uploaded successfully to GitHub Packages."
if ($LASTEXITCODE -ne 0) {
